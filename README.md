...
- [Kurdish Language Processing Toolkit](https://github.com/sinaahmadi/klpt) Kurdish Language Processing Toolkit--KLPT is a natural language processing (NLP) toolkit in Python for the Kurdish language.
